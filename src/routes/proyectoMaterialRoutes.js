...
const { getProyectoMaterialEnProgreso, createProyectoMaterial, getProyectoMaterialById, entregarMaterialAObra } = require('../controllers/proyectoMaterialController');
...
router.put('/entregar-obra', entregarMaterialAObra);
